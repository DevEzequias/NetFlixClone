...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setupAnimation(lottie: "splashMovie")
    ...
    private func configureNavBar() {
        ...
        let barButton = UIBarButtonItem(image: image, style: .done, target: self, action: nil)
            barButton.imageInsets = UIEdgeInsets(top: -4, left: -80, bottom: -4, right: 0)
...
// MARK: - CollectionViewTableViewCellDelgate

extension HomeViewController: CollectionViewTableViewCellDelgate {
